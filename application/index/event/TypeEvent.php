...
// +----------------------------------------------------------------------
// | TypeEvent.php  By Taoge 2017/9/28 11:41
// +----------------------------------------------------------------------
...
{
    //登录成功，获取支付宝用户信息
    public function alipay($token)
    {
        $alipay = ThinkOauth::getInstance('alipay', $token);
        $data   = $alipay->call('alipay.user.info.share');
        if ($data['code'] == 10000) {
            $userInfo['type']   = 'ALIPAY';
            $userInfo['name']   = $data['user_id'];
            $userInfo['nick']   = $data['nick_name'];
            $userInfo['head']   = $data['avatar'];
            $userInfo['openid'] = $alipay->openid();
            $UserApi            = new UserApi();
            return $UserApi->oauth($userInfo);
        } else {
            throw new \think\Exception("获取支付宝用户信息失败：{$data['msg']}");
        }
    }
    ...
    public function tencent($token)
    {
        ...
        if ($data['ret'] == 0) {
            ...
            throw new \think\Exception("获取腾讯微博用户信息失败：{$data['msg']}");
        }
    }
    ...
    public function sina($token)
    {
        ...
        if ($data['error_code'] == 0) {
            ...
            $userInfo['openid'] = $sina->openid();
            $UserApi            = new UserApi();
            return $UserApi->oauth($userInfo);
        } else {
            throw new \think\Exception("获取新浪微博用户信息失败：{$data['error']}");
        }
    }
    ...
    public function t163($token)
    {
        ...
        if ($data['error_code'] == 0) {
            ...
            throw new \think\Exception("获取网易微博用户信息失败：{$data['error']}");
        }
    }
    ...
    public function renren($token)
    {
        ...
        if (!isset($data['error_code'])) {
            ...
            throw new \think\Exception("获取人人网用户信息失败：{$data['error_msg']}");
        }
    }
    ...
    public function x360($token)
    {
        ...
        if ($data['error_code'] == 0) {
            ...
            throw new \think\Exception("获取360用户信息失败：{$data['error']}");
        }
    }
    ...
    public function douban($token)
    {
        ...
        if (empty($data['code'])) {
            ...
            throw new \think\Exception("获取豆瓣用户信息失败：{$data['msg']}");
        }
    }
    ...
    public function github($token)
    {
        ...
        if (empty($data['code'])) {
            ...
            throw new \think\Exception("获取Github用户信息失败：{$data}");
        }
    }
    ...
    public function google($token)
    {
        ...
        if (!empty($data['id'])) {
            ...
            throw new \think\Exception("获取Google用户信息失败：{$data}");
        }
    }
    ...
    public function msn($token)
    {
        ...
        if (!empty($data['id'])) {
            ...
            throw new \think\Exception("获取msn用户信息失败：{$data}");
        }
    }
    ...
    public function diandian($token)
    {
        ...
        if (!empty($data['meta']['status']) && $data['meta']['status'] == 200) {
            ...
            throw new \think\Exception("获取点点用户信息失败：{$data}");
        }
    }
    ...
    public function taobao($token)
    {
        ...
        if (!empty($data['user_buyer_get_response']['user'])) {
            ...
            throw new \think\Exception("获取淘宝网用户信息失败：{$data['error_response']['msg']}");
        }
    }
    ...
    public function baidu($token)
    {
        ...
        if (!empty($data['uid'])) {
            ...
            $userInfo['openid'] = $data['uid'];
            $UserApi            = new UserApi();
            return $UserApi->oauth($userInfo);
        } else {
            throw new \think\Exception("获取百度用户信息失败：{$data['error_msg']}");
        }
    }
    ...
    public function kaixin($token)
    {
        ...
        if (!empty($data['uid'])) {
            ...
            throw new \think\Exception("获取开心网用户信息失败：{$data['error']}");
        }
    }
    ...
    public function sohu($token)
    {
        ...
        if ('success' == $data['message'] && !empty($data['data'])) {
            ...
            throw new \think\Exception("获取搜狐用户信息失败：{$data['message']}");
        }
    }
